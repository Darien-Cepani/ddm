...
const LANG = {
  en: {
    ...
    visit: {
      ...
      body: "Step into Vanya Flowers to choose your blooms in person, or order for same-day delivery across the city. Our florists are always happy to help you craft the perfect gift.",
    ...
    toast: {
      ...
      newsletter: "Welcome to the Vanya Flowers list! 🌷",
  ...
  sq: {
    ...
    visit: {
      ...
      body: "Hyni në Vanya Flowers për të zgjedhur lulet personalisht, ose porosisni për dërgesë brenda ditës në të gjithë qytetin. Floristët tanë janë gjithmonë të gatshëm t'ju ndihmojnë të krijoni dhuratën perfekte.",
    ...
    toast: {
      ...
      newsletter: "Mirë se vini te lista e Vanya Flowers! 🌷",
...
// Brand mark — Vanya eight-petal daisy bloom (matches Brand/logo.svg). Uses
...
export default function App() {
  ...
  useEffect(() => {
    ...
    document.title = lang === "sq"
      ? "Vanya Flowers — Trëndafila, Buqeta & Lule Sezonale në Tiranë"
      : "Vanya Flowers — Roses, Bouquets & Seasonal Blooms in Tirana";
  }, [lang]);
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-4 md:px-12 grid grid-cols-1 lg:grid-cols-12 gap-10 md:gap-16 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col gap-4">
            ...
            <div className="relative w-full h-[300px] sm:h-[350px] md:h-[450px] bg-brand-champagne border border-brand-champagne shadow-md overflow-hidden mt-4">
              <div id="map" role="img" aria-label="Map showing Vanya Flowers in Tirana" className="w-full h-full absolute inset-0 z-10 desaturate-map" />
